        ...
        for (SectionType section : SectionType.values()) {
            switch (section) {
                ...
                case ACHIEVEMENT -> {
                    ...
                    objectiveList.add("С 2013 года: разработка проектов " +
                ...
                case EXPERIENCE -> {
                    ...
                    experienceList.add(new Experience("Java Online Projects"
                            , "http://javaops.ru/"
                            , YearMonth.of(2013, 10)
                            , YearMonth.now()
                            , "Автор проекта."
                            , "Создание, организация и проведение Java онлайн проектов и стажировок."));
                    experienceList.add(new Experience("Wrike"
                            , "https://www.wrike.com/"
                    ...
                    experienceList.add(new Experience("RIT Center"
                            , ""
                            , YearMonth.of(2012, 4)
                            , YearMonth.of(2014, 10)
                            , "Автор проекта."
                ...
                case EDUCATION -> {
                    ...
                    educationList.add(new Experience("Coursera"
                            , "https://www.coursera.org/course/progfun"
                            , YearMonth.of(2013, 3)
                            , YearMonth.of(2013, 5)
                            , ""
                            , "\"Functional Programming Principles in Scala\" by Martin Odersky"));
                    educationList.add(new Experience("Luxoft"
